...
シーン内のサポートする全てのオブジェクトを書き出します。Export Hidden Itemsがオフの場合は、非表示のオブジェクトは出力されません。<br>
...
### Bridge for Modo v1.0.2 バグ修正

- 負のエッジウェイト値に関するエラーを修正
- インスタンスのソースアイテムが非表示の場合でもエクスポート
- アセットライブラリ内の画像パスのエイリアスに対応
- グループロケーターをEMPTYオブジェクトとしてエクスポート

### Bridge for Modo v1.0.3 バグ修正

- リプリケータのソースアイテムが非表示の場合でもエクスポートするように修正
- Export Hidden Itemsオプションを追加

### Bridge for Blender v1.0.1 バグ修正
...
### Bridge for Blender v1.0.2 マイナーチェンジ

- ディスプレースメントテクスチャのサポート

### Bridge for Modo v1.0.5 マイナーチェンジ

- ディスプレースメントテクスチャのサポート
- インスタンスアイテムの選択出力でソースアイテムのデータが出力されない問題を修正

### Bridge for Blender v1.0.3 バグ修正

- オブジェクトコピー中の潜在的なエラーの発生を防止するように修正
- ペイントモードでのエラーを修正

### Bridge for Blender v1.0.4 バグ修正
